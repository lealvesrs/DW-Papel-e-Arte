...
VALUES
  ('admin', crypt('admin', gen_salt('bf'))), -- senha: admin
  ('qwe',   crypt('qwe',   gen_salt('bf')))  -- senha: qwe
...
-- =========================================================
-- ÍNDICES (desempenho em filtros comuns)
-- =========================================================
...
-- =========================================================
-- DADOS DE EXEMPLO (seed) PARA RODAR OS TESTES
-- =========================================================

-- Fornecedores (insere pelo menos 2 para termos IDs 1 e 2 em um banco vazio)
...
-- Contas a Pagar (duas primeiras entradas garantem IDs 1 e 2 em banco novo)
...
-- =========================================================
-- CONSULTAS RÁPIDAS (opcionais) PARA VERIFICAR O SEED
-- (Se não quiser saída ao aplicar o script, remova os SELECTs abaixo)
-- =========================================================
-- Fornecedores ativos
